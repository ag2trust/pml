...
- The handoff correctly labels 0008 unimplemented ([`HANDOFF.md`:20-25](../../HANDOFF.md)),
  ...
  That reference is copied by initialization, so it affects its non-normative
  guidance but not initialization semantics.
